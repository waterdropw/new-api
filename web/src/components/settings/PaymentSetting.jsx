...
import SettingsPaymentGatewayDirect from '../../pages/Setting/Payment/SettingsPaymentGatewayDirect';
  ...
  return (
    <>
      <Spin spinning={loading} size='large'>
        ...
        <Card style={{ marginTop: '10px' }}>
          <SettingsPaymentGatewayDirect options={inputs} refresh={onRefresh} />
        </Card>
      </Spin>
    </>
  );
